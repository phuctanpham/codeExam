/*
================================================================================
MergeSort - Sắp xếp TĂNG DẦN
================================================================================
Dựa vào đoạn code mẫu trong slide bài giảng, hãy cài đặt và tùy chỉnh thuật toán sắp xếp MergeSort để sắp xếp mảng số nguyên A theo trật tự tăng dần và in ra màn hình theo mẫu ví dụ.
...
Mang B: 3 8 1 7
Mang C: 0 2 4
Mang A (sau khi gop): 0 3 2 8 1 4 7
...
