...
// --- Base Class: shared display fields ---
// FIX (minor): diaChi was captured during input but never shown; added here.
...
// [Overloading + Polymorphism] operator<< dispatches to the correct displayInfo()
...
bool SinhVienCaoDang::checkTotNghiep() const {
    // Criteria: credits >= 110, GPA >= 5.0, graduation exam >= 5.0
...
bool SinhVienDaiHoc::checkTotNghiep() const {
    // Criteria: credits >= 145, GPA >= 5.0, thesis score >= 5.0
